...
def load_static_layers():
    """Loads the static geospatial layers once -- reusable across both
    run_for_all_points() and compute_for_arbitrary_point()."""
    ...
    return industrial_zones, construction_zones, road_midpoints
...
def run_for_all_points():
    ...
    latest_traffic_ts = traffic_log["timestamp"].max()
    latest_traffic = traffic_log[traffic_log["timestamp"] == latest_traffic_ts]
